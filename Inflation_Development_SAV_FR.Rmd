...
sel_M$LOCATION <- factor(sel_M$LOCATION, levels=c("Suisse","Allemagne","UE-27","États-Unis"))
sel_A$LOCATION <- factor(sel_A$LOCATION, levels=c("Suisse","Allemagne","UE-27","États-Unis"))
...
png('~/Repos/Inflation/graphics/infl_country_M_FR.png')
print(p1)
dev.off()
...
png('~/Repos/Inflation/graphics/infl_country_A.png')
print(p2)
dev.off()
...
png('~/Repos/Inflation/graphics/infl_country_M_wrap.png')
print(p1)
dev.off()
...
**Land** | **Infl.rate** **`r format(sel_M$Time[length(sel_M$Time)-1],"%B")`** | **Infl.rate** **`r format(sel_M$Time[length(sel_M$Time)],"%B")`**
------------- | -------------|-------------
...
png('~/Repos/Inflation/graphics/infl_core_M.png')
print(p)
dev.off()
...
png('~/Repos/Inflation/graphics/infl_nrg_M.png')
print(p)
dev.off()
```
...
xlsx <- read_excel("20220419_Löhne_Inflation_FR.xlsx",sheet=3,range ="A23:D36")
xlsx <- xlsx[,-2]
...
png('~/Repos/Inflation/graphics/real_wage_prod_FR.png')
print(p)
dev.off()
```
...
dat_2020 <- filter(dat,unit=="RCH_A", coicop=="CP00", geo %in% ct,time=="2022-06-01") #dat$time[1]) #geo==ct)) & indic_is==ty))#time="2019-01-01")# & indic_is=ty)
...
png('~/Repos/Inflation/graphics/Cons_mood.png')
print(p)
dev.off()
