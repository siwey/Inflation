---
title: "Inflation, kehrt sie auf ein erträgliches Niveau zurück?"
author:
...
* Im September wurde die Trendwende der Inflation in der Schweiz fürs Erste erreicht. Sie ging im Vergleich zum Vorjahr um 0.2 Prozentpunkte zurück und lag im September bei 3.3 Prozent. Dies im Unterschied zu vielen anderen europäischen Ländern. 
...
**Grossbritannien** | `r paste(paste0(month(sel_M$Time[sel_M$LOCATION=="Grossbritannien"][length(sel_M$Time[sel_M$LOCATION=="Grossbritannien"])],label=TRUE),":"), round(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])],1))` | `r if (round(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])]-sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])-1],1)>=0){paste0("+", round(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])]-sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])-1],1))} else {round(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])]-sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])-1],1)}` | `r if (round(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])]-sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"][length(sel_M$ObsValue[sel_M$LOCATION=="Grossbritannien"])-1],1)>=0) {"$\\uparrow$"} else {"$\\downarrow$"}`
Table: Die Inflationsraten der Schweiz und ausgewählten Ländern der EU. Zudem die beiden Raten der EU-27 und der USA (vgl. Abbildung \ref{Inf_C}). Quelle: OECD
